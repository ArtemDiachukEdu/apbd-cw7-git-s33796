...
namespace ApbdCw7.Infrastructure.Migrations
{
    ...
    [Migration("20260526144040_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.Component", b =>
                {
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.Pc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.PcComponent", b =>
                {
                    b.Property<int>("PcId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.Component", b =>
                {
                    b.HasOne("ApbdCw7.Infrastructure.Entities.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                    ...
                    b.HasOne("ApbdCw7.Infrastructure.Entities.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("ApbdCw7.Infrastructure.Entities.PcComponent", b =>
                {
                    b.HasOne("ApbdCw7.Infrastructure.Entities.Component", "Component")
                    ...
                    b.HasOne("ApbdCw7.Infrastructure.Entities.Pc", "Pc")
                        .WithMany("PcComponents")
                        .HasForeignKey("PcId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
